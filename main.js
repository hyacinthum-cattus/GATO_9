...
function nueva_imagen(get_image)
{
	...
	bloque_objeto_imagen.scaleToHeight (block_image_height); bloque_objeto_imagen.set({top:block_y,left: block_x}); lienzo.add(bloque_objeto_imagen);
	});
}
...
console.log(teclaPresionada);
	...
	if(teclaPresionada == 71 ) 
	{
		{
			block_x = 10 ;
			nueva_imagen('rojo.jpg'); console.log('R')
			}
	...
	if(teclaPresionada == 82 )
	{
		...
		{
			block_x = 310 ;
			nueva_imagen('verde.png'); console.log('G')
			}
	...
	if(teclaPresionada == 89 )
	{
		{
			block_x = 560 ;
			nueva_imagen('amarillo.png'); console.log('Y')
			}
	...
	if(teclaPresionada == 80 )
	{
		{
			block_x = 880 ;
			nueva_imagen('rosa.png'); console.log('P')
			}
	...
	if(teclaPresionada == 66 )
	{
		{
			block_x = 1040 ;
			nueva_imagen('azul.png'); console.log('B')
			}
